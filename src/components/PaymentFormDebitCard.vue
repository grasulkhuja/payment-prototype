<template>
  <div
    class="w-72 h-52 sm:w-96 sm:h-56 bg-red-100 rounded-xl relative text-white shadow-2xl transition-transform transform hover:scale-105 mt-4"
  >
    <img
      class="relative object-cover w-full h-full rounded-xl"
      :src="
        'https://10.1.1.12/static/bgs/card/' + currentCardBackground + '.jpeg'
      "
      alt="Card background"
    />
